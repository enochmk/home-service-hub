...
export async function verifyUserExists(req: Request, res: Response, next: NextFunction) {
...
export async function verifyEmailAvailability(req: Request, res: Response, next: NextFunction) {
